...
**方案**：在 Embedding 前拼接极简自然语言定调前缀，作为"语义锚点"。前缀本身是自然语言短句（如 `[作品名] `），而非机械的 key-value 模板，不会稀释语义质心。

| 实体类型 | 前缀模板 | chunk_text 示例 |
|---|---|---|
| Subject | `[作品名] {name_cn}。{chunk}` | `[作品名] 进击的巨人。在巨人支配的世界中，少年艾伦...` |
| Character | `[角色] {name_cn}，出自《{subject_name}》。{chunk}` | `[角色] 艾伦·耶格尔，出自《进击的巨人》。憧憬外面世界的少年...` |
| Person | `[人物] {name_cn}。{chunk}` | `[人物] 梶裕贵。日本男性声优，代表作包括...` |
