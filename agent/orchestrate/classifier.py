...
- emotional: 用户有明显的情绪或状态表达（"失恋了"、"太开心了"、"好无聊"、"心情不好"、"今天好累"、"烦死了"、"郁闷"）。注意：用户说"好累"、"好无聊"时归为 emotional，不是 discovery——他们是在表达状态，不是在要求推荐
...
- **用户表达情绪或状态（"好累"、"好无聊"、"烦死了"）时归为 emotional，不要归为 discovery——他们可能只是想说一说，不是在要推荐**
